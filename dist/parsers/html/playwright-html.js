...
export function extractPlaywrightJSON(htmlFilePath) {
    try {
        ...
        throw new Error(`Failed to extract JSON from Playwright HTML: ${error instanceof Error ? error.message : String(error)}`);
    }
}
//# sourceMappingURL=playwright-html.js.map