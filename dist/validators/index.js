...
import { validateESLintOutput, validateTSCOutput, validateFlake8Output, validateRuffOutput, validateMypyOutput, } from "./linter-validator.js";
 ...
 */
export function validate(type, content) {
