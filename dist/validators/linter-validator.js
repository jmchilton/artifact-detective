export function validateESLintOutput(content) {
...
export function validateTSCOutput(content) {
...
export function validateFlake8Output(content) {
...
export function validateRuffOutput(content) {
    // Ruff output pattern:
    // path/to/file.py:line:col: CODE [*] message
...
export function validateMypyOutput(content) {
    // Mypy output pattern:
...
//# sourceMappingURL=linter-validator.js.map