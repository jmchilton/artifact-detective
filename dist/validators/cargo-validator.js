 ...
 */
export function validateCargoTestOutput(content) {
    ...
    const testLinePattern = /test\s+\S+\s+\.\.\.\s+(ok|FAILED|ignored)/i.test(content);
...
//# sourceMappingURL=cargo-validator.js.map